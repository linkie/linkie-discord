...
fun registerCommands(commandApi: CommandApi) {
    ...
    if (commands) {
        commandApi.registerCommand(QueryClassMethod(Namespaces["yarn"]), "yc")
        ...
        commandApi.registerCommand(QueryMethodCommand(Namespaces["yarn"]), "ym")
        ...
        commandApi.registerCommand(QueryFieldCommand(Namespaces["yarn"]), "yf")
