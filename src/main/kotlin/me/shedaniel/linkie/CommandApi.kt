...
class CommandApi(private val prefix: String) {
    internal val commandMap: MutableMap<String, CommandBase> = mutableMapOf()
        ...
        LinkieBot.executors.submit {
            ...
            if (message.toLowerCase(Locale.ROOT).startsWith(prefix)) {
                ...
                if (commandMap.containsKey(cmd))
                    try {
                        commandMap[cmd]!!.execute(LinkieBot.executors, event, member, cmd, args, channel)
