    ...
    override fun execute(event: MessageCreateEvent, user: User, cmd: String, args: Array<String>, channel: MessageChannel) {
        ...
        try {
            ...
            mappingsContainer.classes.forEach { clazz ->
                builder.append("extendable class ${clazz.mappedName ?: clazz.intermediaryName}\n")
                clazz.methods.forEach { method ->
                    builder.append("accessible method ${clazz.mappedName ?: clazz.intermediaryName} ${method.mappedName ?: method.intermediaryName} " +
                            "${method.mappedDesc ?: method.intermediaryDesc.mapIntermediaryDescToNamed(mappingsContainer)}\n")
                }
                clazz.fields.forEach { field ->
                    builder.append("accessible field ${clazz.mappedName ?: clazz.intermediaryName} ${field.mappedName ?: field.intermediaryName} " +
                            "${field.mappedDesc ?: field.intermediaryDesc.mapIntermediaryDescToNamed(mappingsContainer)}\n")
                }
            }
