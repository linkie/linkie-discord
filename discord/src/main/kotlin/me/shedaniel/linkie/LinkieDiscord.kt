...
fun registerCommands(commandApi: CommandApi) {
    if (commands) {
        ...
        commandApi.registerCommand(QueryClassMethod(Namespaces["plasma"]), "plasmac")
        ...
        commandApi.registerCommand(QueryMethodCommand(Namespaces["plasma"]), "plasmam")
        ...
        commandApi.registerCommand(QueryFieldCommand(Namespaces["plasma"]), "plasmaf")
